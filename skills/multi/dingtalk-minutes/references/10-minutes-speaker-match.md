...
| ② 高   | 人员 + 组织架构  | `dws aisearch person --query <姓名> --dimension name --format json` → userId，再 `dws contact user get --ids <userId>` 补详情 |
